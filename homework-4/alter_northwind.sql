...
/* Удаляем строки из таблицы products по условию */
DELETE FROM products
WHERE products.discontinued = 1
/* Удаляем неактуальные строки из таблицы order_details*/
DELETE FROM order_details
WHERE order_details.product_id NOT IN (SELECT product_id FROM products)
